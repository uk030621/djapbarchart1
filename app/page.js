...
export default function Home() {
  ...
  return (
    <div>
      <a href="https://mortadvise1.vercel.app/" onclick="window.close()" rel="noopener noreferrer"style={{ color: 'blue', textDecoration: 'underline' }}>Advisor Mortgage Tracking</a>
